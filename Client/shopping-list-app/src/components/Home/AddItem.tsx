...
import { useItems, useUI } from "@/app/hooks";
...
export function AddItem() {
    ...
    return(
        <div className="w-full bg-[#5f3655] h-36 rounded-xl flex">
            <BattleSVG width="100" height="auto" />
            <div className="w-auto h-full flex flex-col justify-center gap-4">
                <h2 className="text-slate-50 font-bold tracking-wide">Didn’t find what you need?</h2>
                <ButtonComponent
